<?php /* Template_ 2.2.3 2016/07/28 14:36:26 /home/hosting_users/hospi/www/application/views/board/skin/board/list_board.htm */
...
<tr>
<td>공지</td>
<td><p class="title"><a href="/user/board/read_view/<?php echo $TPL_V1["num_mcode"]?>/<?php echo $TPL_V1["num_serial"]?>?cate=<?php echo $TPL_VAR["cate"]?>&ch=<?php echo $_GET["ch"]?>"><strong><strong>[공지]</strong> <?php echo $TPL_V1["str_title"]?></strong></a></p></td>
...
<td><p class="title " style="margin-top:12px">
