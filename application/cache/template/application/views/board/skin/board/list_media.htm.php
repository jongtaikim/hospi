<?php /* Template_ 2.2.3 2015/12/08 15:30:46 /disk1/home/hospi/www/application/views/board/skin/board/list_media.htm */
...
<th width="67.7%" scope="col" class="subject text-center">subject</th>
...
<!-- //i.ytimg.com/vi/yULZ64pFt4E/mqdefault.jpg -->
<div style="overflow:hidden;width:196px;height:110px;margin:25px 15px">
<?php if(!$TPL_V1["str_file_url1"]&&strstr($TPL_V1["str_mov"],'//youtu.be/')){?>
<?
$utb_code =  $TPL_V1["str_mov"];
$utb_code_ = explode("youtu.be/",$utb_code);
$utb_codes = $utb_code_[1];
?>
<img src="//i.ytimg.com/vi/<?=$utb_codes?>/mqdefault.jpg" alt="" style="height:110px;"/>
<?php }else{?>
<img src="<?php echo $TPL_V1["str_file_url1"]?>" alt="" style="height:100px;"/>
<?php }?>
</div>
</a>
</div>
<div class="col-md-7" id="">
<p class="title" style="margin:24px 0 15px 0;padding-left:0px">
...
<div class=" text-left p-b20" id="" style="font-size:12px">
