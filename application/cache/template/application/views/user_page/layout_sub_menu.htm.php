<?php /* Template_ 2.2.3 2016/08/17 16:17:40 /home/hosting_users/hospi/www/application/views/user_page/layout_sub_menu.htm */?>
<!DOCTYPE html>
...
<div class="b-b b-t col-md-12" id="" style="height:352px;padding:0px;margin:0px;background:url(/application/views/user_page/images/sub_visual/login.jpg) no-repeat center top;background-color:#cdcdcd">
</div>
<div style="clear:left"></div>
<div class="cont2 text-center" id="content" style="margin:10px auto;padding-top:20px;padding-bottom:20px;min-height:500px;padding-left:130px">
