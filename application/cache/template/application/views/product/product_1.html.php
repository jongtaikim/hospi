<?php /* Template_ 2.2.3 2016/10/04 13:10:59 /home/hosting_users/hospi/www/application/views/product/product_1.html */?>
...
<tbody>
<tr>
<td width="5%" style="padding-right:30px"><img src="/images/product/1/logo.jpg" style="width:140px" /></td>
<td class="h4"><strong>보행분석계</strong></td>
</tr>
<tr>
<td colspan="2" style="padding-top:20px;padding-bottom:10px;font-size:15px">Oqus 적외선 카메라를 활용해
반사마커(Reflective Marker)를 캡쳐하여
인체 및 사물의 다양한 변인을 실시간으로
분석하는데 사용</td>
</tr>
</tbody>
</table>
...
<img src="/images/product/1/product.jpg" style="width: 80%;">
</td>
<td class="text-right _100" valign="top" style="width:140px;">품목명/모델명</td>
<td style="" valign="top">보행분석계 - Qualisys </td>
</tr>
<tr>
<td class="text-right _100 b-t" valign="top" style="">제조국/제조사
</td>
<td style="" valign="top" class="b-t">스웨덴 Qualisys AB</td>
</tr>
<tr>
<td class="text-right b-t" valign="top" style="">적용분야</td>
<td style="" valign="top" class="b-t">1. Gait Analysis & Rehabilitation<br />
</td>
</tr>
</tbody>
</table>
...
<a class="p-a block text-center" href="/user/ctl_online/item_add/1410/1?cate=1410&db_title=s1&product_name=%EB%B3%B4%ED%96%89%EB%B6%84%EC%84%9D%EA%B3%84"><i class="material-icons md-24  m-v-sm inline"></i>
<span class="block">견적문의</span>
</a>
</div>
<div class="col-xs-4 b-r">
<a class="p-a block text-center" href="/user/ctl_online/item_add/1411/1?cate=1411&db_title=s2&product_name=%EB%B3%B4%ED%96%89%EB%B6%84%EC%84%9D%EA%B3%84">
<i class="material-icons md-24  m-v-sm inline"></i>
<span class="block">A/S문의</span>
</a>
</div>
<div class="col-xs-4">
<a class="p-a block text-center" href="/user/ctl_online/item_add/1812/1?cate=1812&db_title=s8&product_name=%EB%B3%B4%ED%96%89%EB%B6%84%EC%84%9D%EA%B3%84"><i class="material-icons md-24  m-v-sm inline"></i>
...
내용변경<br />
<br />
1.보행 능력의 감퇴와 치료에 따른 기능 회복을 객관적으로 알기 위한 분석 장치<br />
2.2D 및 3D로 데이터 분석<br />
3.무선통신(wireless) 가능<br />
4.고속 비디오 기능 가능 (옵션)<br />
5.Active Marker 인식기능이 있어 야외에서도 사용 가능<br />
6.별도의 워크스테이션이 필요하지 않음<br />
7.주변장치(EMG, Force platform, Foot pressure) 등과 쉽게 동기화<br />
<br />
...
<img src="/images/product/1/p1/2.jpg" style="width:100%">
