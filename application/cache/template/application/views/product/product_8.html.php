<?php /* Template_ 2.2.3 2016/10/04 13:11:53 /home/hosting_users/hospi/www/application/views/product/product_8.html */?>
...
<tbody>
<tr>
<td width="5%" style="padding-right:30px"><img src="/images/product/8/logo.jpg" style="width:140px" /></td>
<td class="h4"><strong>전자식 의료용 측각도계</strong></td>
</tr>
<tr>
<td colspan="2" style="padding-top:20px;padding-bottom:10px;font-size:15px">손가락, 팔, 사지 등 인체 위치의 각도를 측정하거나 의료용으로써 신체의 표면 온도를 자기 발산 적외선으로 사진 및 영상으로 촬영
</td>
</tr>
</tbody>
</table>
...
<img src="/images/product/8/product.jpg" style="width: 27%;">
</td>
<td class="text-right _100" valign="top" style="width:140px;">품목명/모델명</td>
<td style="" valign="top">전자식 의료용 측각도계 - ABW Mapper Stand </td>
</tr>
<tr>
<td class="text-right _100 b-t" valign="top" style="">제조국/제조사
</td>
<td style="" valign="top" class="b-t">독일 GmbH</td>
</tr>
<tr>
...
<a class="p-a block text-center" href="/user/ctl_online/item_add/1410/1?cate=1410&db_title=s1&product_name=%EC%A0%84%EC%9E%90%EC%8B%9D+%EC%9D%98%EB%A3%8C%EC%9A%A9+%EC%B8%A1%EA%B0%81%EB%8F%84%EA%B3%84"><i class="material-icons md-24  m-v-sm inline"></i>
<span class="block">견적문의</span>
</a>
</div>
<div class="col-xs-4 b-r">
<a class="p-a block text-center" href="/user/ctl_online/item_add/1411/1?cate=1411&db_title=s2&product_name=%EC%A0%84%EC%9E%90%EC%8B%9D+%EC%9D%98%EB%A3%8C%EC%9A%A9+%EC%B8%A1%EA%B0%81%EB%8F%84%EA%B3%84">
<i class="material-icons md-24  m-v-sm inline"></i>
<span class="block">A/S문의</span>
</a>
</div>
<div class="col-xs-4">
<a class="p-a block text-center" href="/user/ctl_online/item_add/1812/1?cate=1812&db_title=s8&product_name=%EC%A0%84%EC%9E%90%EC%8B%9D+%EC%9D%98%EB%A3%8C%EC%9A%A9+%EC%B8%A1%EA%B0%81%EB%8F%84%EA%B3%84"><i class="material-icons md-24  m-v-sm inline"></i>
...
1.피험자의 신장을 입력하면 자동 높이 조절 가능<br />
2.적외선 카메라로 신체 온도 측정(옵션)<br />
3.과전류 차단을 위한 안전장치 장착<br />
<br />
...
<img src="/images/product/8/bg.jpg" alt="" style="width:100%"/>
</div>
</div>
<div class="box box-shadow  clearfix  b-l b-r">
</div>
