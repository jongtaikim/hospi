<?php /* Template_ 2.2.3 2016/10/05 16:55:42 /home/hosting_users/hospi/www/application/views/product/product_2.html */?>
...
<tbody>
<tr>
<td width="5%" style="padding-right:30px"><img src="/images/product/2/logo.jpg" style="width:140px" /></td>
<td class="h4"><strong>보행분석계</strong></td>
</tr>
<tr>
<td colspan="2" style="padding-top:20px;padding-bottom:10px;font-size:15px">실시간으로 보행에서 나타나는 변인
분석 및 레포팅 제공</td>
</tr>
</tbody>
</table>
...
<img src="/images/product/2/product.jpg" style="width: 80%;">
</td>
<td class="text-right _100" valign="top" style="width:140px;">품목명/모델명</td>
<td style="" valign="top">보행분석 시스템 - Optogait </td>
</tr>
<tr>
...
<td style="" valign="top" class="b-t">Gait Analysis & Rehabilitation<br />
</td>
</tr>
</tbody>
</table>
...
<a class="p-a block text-center" href="/user/ctl_online/item_add/1410/1?cate=1410&db_title=s1&product_name=%EB%B3%B4%ED%96%89%EB%B6%84%EC%84%9D+%EC%8B%9C%EC%8A%A4%ED%85%9C"><i class="material-icons md-24  m-v-sm inline"></i>
<span class="block">견적문의</span>
</a>
</div>
<div class="col-xs-4 b-r">
<a class="p-a block text-center" href="/user/ctl_online/item_add/1411/1?cate=1411&db_title=s2&product_name=%EB%B3%B4%ED%96%89%EB%B6%84%EC%84%9D+%EC%8B%9C%EC%8A%A4%ED%85%9C">
<i class="material-icons md-24  m-v-sm inline"></i>
<span class="block">A/S문의</span>
</a>
</div>
<div class="col-xs-4">
<a class="p-a block text-center" href="/user/ctl_online/item_add/1812/1?cate=1812&db_title=s8&product_name=%EB%B3%B4%ED%96%89%EB%B6%84%EC%84%9D+%EC%8B%9C%EC%8A%A4%ED%85%9C"><i class="material-icons md-24  m-v-sm inline"></i>
...
2. 치료 진행에 따른 보행 개선여부 비교 평가 가능<br />
3. 점프, 러닝 분석<br />
4. 최대 6미터까지 좌우 폭을 확대하여 제품을 의식하지 않고 자연스런 보행 분석 가능<br />
5. 환자의 보행 분석 가능<br />
6. 모듈 방식으로 지면에 간단히 설치<br />
7. 1미터 단위로 추가 연장 가능<br />
8. 트레드밀 보행 및 러닝 분석 가능<br />
9. 휴대용 가방을 이용하여 보간 및 이동 간편<br />
<br />
